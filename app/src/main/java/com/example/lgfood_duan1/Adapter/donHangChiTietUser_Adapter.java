...
import com.example.lgfood_duan1.Activity.chiTietDonhangUser_Activity;
...
public class  donHangChiTietUser_Adapter extends RecyclerView.Adapter<donHangChiTietUser_Adapter.ViewHolder> {
    chiTietDonhangUser_Activity mContext;
    ...
    @NotNull
    @Override
    public donHangChiTietUser_Adapter.ViewHolder onCreateViewHolder(@NonNull @NotNull ViewGroup parent, int viewType) {
        View view = LayoutInflater.from(mContext).inflate(R.layout.item_custom_xacnhandathanguser, parent, false);
        return new donHangChiTietUser_Adapter.ViewHolder(view);
    }

    @Override
    public void onBindViewHolder(@NonNull @NotNull donHangChiTietUser_Adapter.ViewHolder holder, int position) {
