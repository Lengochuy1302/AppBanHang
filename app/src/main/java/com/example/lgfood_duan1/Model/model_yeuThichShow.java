...
public class model_yeuThichShow {
    private String
            idSp,
            moTaSp,
            tenSp,
    ...
    private double
            giaNhapSp,
            giaBanSp;
    public model_yeuThichShow(){

    }
    public model_yeuThichShow(String idSp, String moTaSp, String tenSp, String ngaySanXuatSp, String xuatXuSp, String loaiSp, String tinhTrangSp, String anhSp, String ngayNhapSp, int soLuongTrongKho, int giamGiaSp, double giaNhapSp, double giaBanSp) {
        this.idSp = idSp;
        this.moTaSp = moTaSp;
        this.tenSp = tenSp;
